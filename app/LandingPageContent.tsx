  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* Problem Section */}
        <section style={{ padding: '100px 48px' }} id="problem" className="section">
          <div style={{
            fontSize: '10px',
            fontWeight: 500,
          ...
          <div style={{
            ...
            {[
              { num: '01', text: <><strong>Spec paralysis</strong> — teams cannot start until every edge case is documented</> },
        ...
        {/* How It Works */}
        <section style={{ padding: '100px 48px', background: 'var(--paper2)' }} id="how-it-works" className="section">
          <div style={{
            fontSize: '10px',
            fontWeight: 500,
            letterSpacing: '0.25em',
        ...
        {/* Pricing */}
        <section style={{ padding: '100px 48px' }} id="pricing" className="section">
          <div style={{
            fontSize: '10px',
            fontWeight: 500,
            letterSpacing: '0.25em',
